...
export function GoogleCalendarCard({ integration }: GoogleCalendarCardProps) {
  ...
  useEffect(() => {
    ...
    } else if (error && searchParams.get('integration') === 'google_calendar') {
      toast({
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <CardDescription>
                Sync jobs and appointments to Google Calendar
              </CardDescription>
            </div>
          </div>
