...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_estimates_org_status
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_proposals_org_status
ON proposals(organization_id, status);

-- Index for site surveys by organization and status
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_site_surveys_org_status
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_job_time_entries_job
ON job_time_entries(job_id, work_date);

-- Index for job completion photos
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_job_completion_photos_job
