  ...
  const hazards: HazardsData = {
    ...
    asbestos: hazardAssessments.asbestos
      ? {
          materials: hazardAssessments.asbestos.materials.map((m) => ({
            ...
            quantity: m.quantity,
            unit: (m.unit as any) || 'sq_ft',
            location: m.location || '',
            condition: m.condition as any,
          ...
          containmentLevel: hazardAssessments.asbestos.containmentLevel as any,
    ...
    mold: hazardAssessments.mold
      ? {
          ...
          moistureSourceTypes: hazardAssessments.mold.moistureSourceTypes as any[] || [],
          moistureSourceStatus: hazardAssessments.mold.moistureSourceStatus as any,
