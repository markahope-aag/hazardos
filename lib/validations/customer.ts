...
export const customerSchema = z.object({
  ...
  insurance_adjuster_name: z.string().max(255).optional().or(z.literal('')),
  insurance_adjuster_phone: z.string().max(20).optional().or(z.literal('')),
  insurance_adjuster_email: z.string().email('Invalid email').optional().or(z.literal('')),
