...
describe('InvoicesService', () => {
  ...
  // send/email/SMS tests moved to invoice-delivery-service.test.ts along
  // with the implementation. Keeping the sendmarker here would leave a
  // stale mock surface behind that doesn't reflect where the method lives.
  ...
  // recordPayment/deletePayment tests moved to
  // invoice-payments-service.test.ts alongside the implementation.
