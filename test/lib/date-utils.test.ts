...
describe('Date Utilities', () => {
  describe('Date Formatting', () => {
    ...
    it('should handle invalid dates gracefully', () => {
      ...
      invalidDates.forEach(dateStr => {
        if (dateStr) {
          const parsed = parseISO(dateStr as string)
  ...
  describe('Day Boundaries', () => {
    it('should get start of day', () => {
      const date = new Date('2026-01-31T15:30:45.123Z')
  ...
  describe('Business Logic Helpers', () => {
    ...
    it('should check if date is today', () => {
      ...
      const today = new Date('2026-01-31T10:30:00')
      const todayDifferentTime = new Date('2026-01-31T15:45:00')
      const tomorrow = new Date('2026-02-01T10:30:00')
    ...
    it('should format relative time', () => {
      ...
      const reference = new Date('2026-01-31')
