...
// Base defaults for all the (mostly-nullable) fields on Opportunity that
// these tests don't exercise directly, so each fixture below only needs to
// spell out the fields it actually cares about.
const baseOpportunity: Omit<Opportunity, 'id' | 'customer_id' | 'name' | 'description' | 'stage_id' | 'estimated_value' | 'weighted_value' | 'expected_close_date' | 'actual_close_date' | 'owner_id' | 'created_at' | 'updated_at' | 'customer'> = {
  organization_id: 'org_123',
  company_id: null,
